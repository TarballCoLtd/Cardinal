...
func requestUserProfile(user: String, apiKey: String) async throws -> UserProfile {
...
class UserProfile: Profile {
    ...
    let bbProfileText: String
    // let profileAlbum
    let joinedDate: Date
    let lastSeen: Date?
    let uploadedRank: Int?
    let downloadedRank: Int?
    let uploadsRank: Int?
    let requestsRank: Int?
    let bountyRank: Int?
    let postsRank: Int?
    let artistsRank: Int?
    let overallRank: Int?
    ...
    let uploadedTorrents: Int?
    let uniqueUploadGroups: Int?
    let seeding: Int?
    let leeching: Int?
    let snatched: Int?
    let invited: Int?
